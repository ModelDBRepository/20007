...
for three different paths spanning the entire neuron length,
...
Maciej Lazarewicz ([mlazarew@seas.upenn.edu](mailto:mlazarew@seas.upenn.edu))

Questions on how to use the mod files should be directed to
Michele Migliore ([michele.migliore@pa.ibf.cnr.it](mailto:michele.migliore@pa.ibf.cnr.it)).
